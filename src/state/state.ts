...
export let oldColorMap =
  "#000000;#007fff;#b4b400;#7f00c8;#0aa00a;#7f1e1e;#f0b400"
export let defaultColorMap =
  "#0a0a0a;#00c3ff;#ffa700;#0100c8;#00bd00;#b60303;#ffff00;#B0B0B0;#ff57eb"

export let initialState = (window: Window): State => {
  ...
  let isElementary =
    automaton.neighborhoodSize === 3 && automaton.stateCount === 2
  const presentationMode = new URLSearchParams(location.search).has("rule")
    ? "off"
    : "present"
